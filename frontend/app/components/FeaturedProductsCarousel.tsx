    ...
    <div>
      <div className="flex items-center justify-center gap-6 px-4 py-12">
        ...
        <button
          ...
          className="flex-shrink-0 w-16 h-16 rounded-full border-2 border-green-700 text-green-700 hover:bg-green-700 hover:text-white flex items-center justify-center transition-all disabled:opacity-50"
              ...
              >
                <Link href={`/products/${product.id}`} className="block">
                  <img
                    ...
                    alt={product.name}
                    className="h-72 w-full object-cover cursor-pointer hover:opacity-95 transition"
                  />
                </Link>
